...
function minimum_enqueue_scripts() {
	...
	wp_enqueue_style( 'minimum-google-fonts', '//fonts.googleapis.com/css?family=Roboto:300,400,700|Roboto+Slab:300,400', array(), CHILD_THEME_VERSION );

}

//* Add new image sizes
add_image_size( 'portfolio', 540, 340, TRUE );
add_image_size( 'image-une-top-grid', 1140, 330, TRUE );
